...
class _DTSSubscriptionInstanceResource(ServiceResource):
    ...
    def configure(self, **params):
        _params = _transfer_params(params)
        return self._client.configure_subscription_instance(
            subscription_instance_id=self.subscription_instance_id, **_params)

    def configure_subscription_instance_alert(self, **params):
        _params = _transfer_params(params)
        return self._client.configure_subscription_instance_alert(
            subscription_instance_id=self.subscription_instance_id, **_params)

    def delete(self, **params):
        _params = _transfer_params(params)
        return self._client.delete_subscription_instance(
            subscription_instance_id=self.subscription_instance_id, **_params)

    def delete_consumer_group(self, **params):
        _params = _transfer_params(params)
        return self._client.delete_consumer_group(
            subscription_instance_id=self.subscription_instance_id, **_params)

    def describe_subscription_instance_alert(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_subscription_instance_alert(
            subscription_instance_id=self.subscription_instance_id, **_params)

    def describe_subscription_instance_status(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_subscription_instance_status(
            subscription_instance_id=self.subscription_instance_id, **_params)

    def describe_subscription_object_modify_status(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_subscription_object_modify_status(
            subscription_instance_id=self.subscription_instance_id, **_params)

    def modify_consumer_group_password(self, **params):
        _params = _transfer_params(params)
        return self._client.modify_consumer_group_password(
            subscription_instance_id=self.subscription_instance_id, **_params)

    def modify_consumption_timestamp(self, **params):
        _params = _transfer_params(params)
        return self._client.modify_consumption_timestamp(
            subscription_instance_id=self.subscription_instance_id, **_params)

    def modify_subscription_object(self, **params):
        _params = _transfer_params(params)
        return self._client.modify_subscription_object(
            subscription_instance_id=self.subscription_instance_id, **_params)

    def start(self, **params):
        _params = _transfer_params(params)
        return self._client.start_subscription_instance(
            subscription_instance_id=self.subscription_instance_id, **_params)
...
class _DTSSynchronizationJobResource(ServiceResource):
    ...
    def configure(self, **params):
        _params = _transfer_params(params)
        return self._client.configure_synchronization_job(
            synchronization_job_id=self.synchronization_job_id, **_params)

    def configure_synchronization_job_alert(self, **params):
        _params = _transfer_params(params)
        return self._client.configure_synchronization_job_alert(
            synchronization_job_id=self.synchronization_job_id, **_params)

    def delete(self, **params):
        _params = _transfer_params(params)
        return self._client.delete_synchronization_job(
            synchronization_job_id=self.synchronization_job_id, **_params)

    def describe_initialization_status(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_initialization_status(
            synchronization_job_id=self.synchronization_job_id, **_params)

    def describe_synchronization_job_alert(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_synchronization_job_alert(
            synchronization_job_id=self.synchronization_job_id, **_params)

    def describe_synchronization_job_status(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_synchronization_job_status(
            synchronization_job_id=self.synchronization_job_id, **_params)

    def modify_synchronization_object(self, **params):
        _params = _transfer_params(params)
        return self._client.modify_synchronization_object(
            synchronization_job_id=self.synchronization_job_id, **_params)

    def reset(self, **params):
        _params = _transfer_params(params)
        return self._client.reset_synchronization_job(
            synchronization_job_id=self.synchronization_job_id, **_params)

    def start(self, **params):
        _params = _transfer_params(params)
        return self._client.start_synchronization_job(
            synchronization_job_id=self.synchronization_job_id, **_params)

    def suspend(self, **params):
        _params = _transfer_params(params)
        return self._client.suspend_synchronization_job(
            synchronization_job_id=self.synchronization_job_id, **_params)

    def switch_synchronization_endpoint(self, **params):
        _params = _transfer_params(params)
        return self._client.switch_synchronization_endpoint(
            synchronization_job_id=self.synchronization_job_id, **_params)
