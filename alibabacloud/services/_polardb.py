...
class _POLARDBDBClusterResource(ServiceResource):
    ...
    def __init__(self, db_cluster_id, _client=None):
        ...
        self.accounts = _create_sub_resource_without_page_collection(
            ...
            'Accounts.DBAccount', 'AccountName', parent_identifier="DBClusterId",
        ...
        self.backups = _create_sub_resource_with_page_collection(
            ...
            'Items.Backup', 'BackupId', parent_identifier="DBClusterId",
            parent_identifier_value=self.db_cluster_id, key_to_total_count="TotalRecordCount",
            key_to_page_size="PageRecordCount", key_to_page_number="PageNumber"
        )
        self.databases = _create_sub_resource_without_page_collection(
            _POLARDBDatabaseResource, _client, _client.describe_databases,
            'Databases.Database', 'DatabaseName', parent_identifier="DBClusterId",
            parent_identifier_value=self.db_cluster_id
        )
    ...
    def continue_db_cluster_migration(self, **params):
        _params = _transfer_params(params)
        return self._client.continue_db_cluster_migration(db_cluster_id=self.db_cluster_id,
                                                          **_params)
    ...
    def describe_db_cluster_access_whitelist(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_db_cluster_access_whitelist(db_cluster_id=self.db_cluster_id,
                                                                 **_params)

    def describe_db_cluster_attribute(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_db_cluster_attribute(db_cluster_id=self.db_cluster_id,
                                                          **_params)

    def describe_db_cluster_endpoints(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_db_cluster_endpoints(db_cluster_id=self.db_cluster_id,
                                                          **_params)

    def describe_db_cluster_migration(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_db_cluster_migration(db_cluster_id=self.db_cluster_id,
                                                          **_params)

    def describe_db_cluster_parameters(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_db_cluster_parameters(db_cluster_id=self.db_cluster_id,
                                                           **_params)
    ...
    def modify_access_whitelist(self, **params):
        _params = _transfer_params(params)
        return self._client.modify_db_cluster_access_whitelist(db_cluster_id=self.db_cluster_id,
                                                               **_params)
    ...
    def modify_description(self, **params):
        _params = _transfer_params(params)
        return self._client.modify_db_cluster_description(db_cluster_id=self.db_cluster_id,
                                                          **_params)

    def modify_maintain_time(self, **params):
        _params = _transfer_params(params)
        return self._client.modify_db_cluster_maintain_time(db_cluster_id=self.db_cluster_id,
                                                            **_params)
    ...
    def modify_parameters(self, **params):
        _params = _transfer_params(params)
        return self._client.modify_db_cluster_parameters(db_cluster_id=self.db_cluster_id,
                                                         **_params)
...
class _POLARDBAccountResource(ServiceResource):
    ...
    def delete(self, **params):
        ...
        return self._client.delete_account(account_name=self.account_name,
                                           db_cluster_id=self.db_cluster_id, **_params)
...
class _POLARDBBackupResource(ServiceResource):
    ...
    def delete(self, **params):
        _params = _transfer_params(params)
        return self._client.delete_backup(backup_id=self.backup_id,
                                          db_cluster_id=self.db_cluster_id, **_params)
...
class _POLARDBDatabaseResource(ServiceResource):
    ...
    def modify_db_description(self, **params):
        _params = _transfer_params(params)
        return self._client.modify_db_description(database_name=self.database_name,
                                                  db_cluster_id=self.db_cluster_id, **_params)
