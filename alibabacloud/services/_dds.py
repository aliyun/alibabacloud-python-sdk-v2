...
class _DDSDBInstanceResource(ServiceResource):
    ...
    def __init__(self, db_instance_id, _client=None):
        ...
        self.accounts = _create_sub_resource_without_page_collection(
            ...
            'Accounts.Account', 'AccountName', parent_identifier="DBInstanceId",
        ...
        self.backups = _create_sub_resource_without_page_collection(
            ...
            'Backups.Backup', 'BackupId', parent_identifier="DBInstanceId",
            parent_identifier_value=self.db_instance_id
        )

    def allocate_node_private_network_address(self, **params):
        _params = _transfer_params(params)
        return self._client.allocate_node_private_network_address(
            db_instance_id=self.db_instance_id, **_params)

    def allocate_public_network_address(self, **params):
        _params = _transfer_params(params)
        return self._client.allocate_public_network_address(db_instance_id=self.db_instance_id,
                                                            **_params)

    def check_cloud_resource_authorized(self, **params):
        _params = _transfer_params(params)
        return self._client.check_cloud_resource_authorized(db_instance_id=self.db_instance_id,
                                                            **_params)
    ...
    def describe_available_engine_version(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_available_engine_version(db_instance_id=self.db_instance_id,
                                                              **_params)
    ...
    def describe_db_instance_attribute(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_db_instance_attribute(db_instance_id=self.db_instance_id,
                                                           **_params)

    def describe_db_instance_monitor(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_db_instance_monitor(db_instance_id=self.db_instance_id,
                                                         **_params)

    def describe_db_instance_performance(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_db_instance_performance(db_instance_id=self.db_instance_id,
                                                             **_params)
    ...
    def describe_db_instance_tde_info(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_db_instance_tde_info(db_instance_id=self.db_instance_id,
                                                          **_params)

    def describe_error_log_records(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_error_log_records(db_instance_id=self.db_instance_id,
                                                       **_params)

    def describe_parameter_modification_history(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_parameter_modification_history(
            db_instance_id=self.db_instance_id, **_params)
    ...
    def describe_running_log_records(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_running_log_records(db_instance_id=self.db_instance_id,
                                                         **_params)
    ...
    def describe_sharding_network_address(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_sharding_network_address(db_instance_id=self.db_instance_id,
                                                              **_params)
    ...
    def modify_connection_string(self, **params):
        _params = _transfer_params(params)
        return self._client.modify_db_instance_connection_string(db_instance_id=self.db_instance_id,
                                                                 **_params)

    def modify_description(self, **params):
        _params = _transfer_params(params)
        return self._client.modify_db_instance_description(db_instance_id=self.db_instance_id,
                                                           **_params)

    def modify_instance_auto_renewal_attribute(self, **params):
        _params = _transfer_params(params)
        return self._client.modify_instance_auto_renewal_attribute(
            db_instance_id=self.db_instance_id, **_params)

    def modify_instance_vpc_auth_mode(self, **params):
        _params = _transfer_params(params)
        return self._client.modify_instance_vpc_auth_mode(db_instance_id=self.db_instance_id,
                                                          **_params)

    def modify_maintain_time(self, **params):
        _params = _transfer_params(params)
        return self._client.modify_db_instance_maintain_time(db_instance_id=self.db_instance_id,
                                                             **_params)

    def modify_monitor(self, **params):
        _params = _transfer_params(params)
        return self._client.modify_db_instance_monitor(db_instance_id=self.db_instance_id,
                                                       **_params)

    def modify_net_expire_time(self, **params):
        _params = _transfer_params(params)
        return self._client.modify_db_instance_net_expire_time(db_instance_id=self.db_instance_id,
                                                               **_params)

    def modify_network_type(self, **params):
        _params = _transfer_params(params)
        return self._client.modify_db_instance_network_type(db_instance_id=self.db_instance_id,
                                                            **_params)
    ...
    def release_node_private_network_address(self, **params):
        _params = _transfer_params(params)
        return self._client.release_node_private_network_address(db_instance_id=self.db_instance_id,
                                                                 **_params)

    def release_public_network_address(self, **params):
        _params = _transfer_params(params)
        return self._client.release_public_network_address(db_instance_id=self.db_instance_id,
                                                           **_params)
    ...
    def upgrade_db_instance_engine_version(self, **params):
        _params = _transfer_params(params)
        return self._client.upgrade_db_instance_engine_version(db_instance_id=self.db_instance_id,
                                                               **_params)
...
class _DDSBackupResource(ServiceResource):
    ...
    def restore_db_instance(self, **params):
        _params = _transfer_params(params)
        return self._client.restore_db_instance(backup_id=self.backup_id,
                                                db_instance_id=self.db_instance_id, **_params)
