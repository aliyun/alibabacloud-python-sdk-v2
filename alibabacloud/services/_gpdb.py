...
class _GPDBResource(ServiceResource):
    ...
    def __init__(self, _client=None):
        ...
        self.db_instances = _create_resource_collection(
            ...
            'Items.DBInstance', 'DBInstanceId', key_to_total_count="TotalRecordCount",
...
class _GPDBDBInstanceResource(ServiceResource):
    ...
    def __init__(self, db_instance_id, _client=None):
        ...
        self.accounts = _create_sub_resource_without_page_collection(
            ...
            'Accounts.DBInstanceAccount', 'AccountName', parent_identifier="DBInstanceId",
            parent_identifier_value=self.db_instance_id
        )

    def allocate_instance_public_connection(self, **params):
        _params = _transfer_params(params)
        return self._client.allocate_instance_public_connection(db_instance_id=self.db_instance_id,
                                                                **_params)
    ...
    def describe_db_instance_ip_array_list(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_db_instance_ip_array_list(db_instance_id=self.db_instance_id,
                                                               **_params)

    def describe_db_instance_net_info(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_db_instance_net_info(db_instance_id=self.db_instance_id,
                                                          **_params)
    ...
    def describe_sql_collector_policy(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_sql_collector_policy(db_instance_id=self.db_instance_id,
                                                          **_params)
    ...
    def modify_connection_mode(self, **params):
        _params = _transfer_params(params)
        return self._client.modify_db_instance_connection_mode(db_instance_id=self.db_instance_id,
                                                               **_params)
    ...
    def modify_sql_collector_policy(self, **params):
        _params = _transfer_params(params)
        return self._client.modify_sql_collector_policy(db_instance_id=self.db_instance_id,
                                                        **_params)
    ...
    def release_instance_public_connection(self, **params):
        _params = _transfer_params(params)
        return self._client.release_instance_public_connection(db_instance_id=self.db_instance_id,
                                                               **_params)
    ...
    def switch_db_instance_net_type(self, **params):
        _params = _transfer_params(params)
        return self._client.switch_db_instance_net_type(db_instance_id=self.db_instance_id,
                                                        **_params)
