...
class _VPCIPv6TranslatorAclListResource(ServiceResource):
    ...
    def add_ipv6_translator_acl_list_entry(self, **params):
        ...
        return _VPCIPv6TranslatorAclListEntryResource(
            acl_entry_id,self.acl_id, _client=self._client)
    ...
    def refresh(self):
        ...
        if not items:
            raise ClientException(
                msg="Failed to find ipv6_translator_acl_list data from DescribeIPv6TranslatorAclLists response. "
                "AclId = {0}".format(
                    self.acl_id))
        self._assign_attributes(items[0])
...
class _VPCIPv6TranslatorAclListEntryResource(ServiceResource):
    ...
    def modify(self, **params):
        _params = _transfer_params(params)
        self._client.modify_ipv6_translator_acl_list_entry(
            acl_entry_id=self.acl_entry_id,acl_id=self.acl_id, **_params)

    def remove(self, **params):
        _params = _transfer_params(params)
        self._client.remove_ipv6_translator_acl_list_entry(
            acl_entry_id=self.acl_entry_id,acl_id=self.acl_id, **_params)
...
class _VPCIPv6TranslatorEntryResource(ServiceResource):
    ...
    def refresh(self):
        ...
        if not items:
            raise ClientException(
                msg="Failed to find ipv6_translator_entry data from DescribeIPv6TranslatorEntries response. "
...
class _VPCIpv6GatewayResource(ServiceResource):
    ...
    def allocate_ipv6_internet_bandwidth(self, **params):
        _params = _transfer_params(params)
        self._client.allocate_ipv6_internet_bandwidth(
...
class _VPCVSwitchResource(ServiceResource):
    ...
    def describe_vswitch_attributes(self, **params):
        _params = _transfer_params(params)
        self._client.describe_vswitch_attributes(vswitch_id=self.v_switch_id, **_params)
