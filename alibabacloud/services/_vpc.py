...
class _VPCIPv6TranslatorAclListResource(ServiceResource):
    ...
    def add_ipv6_translator_acl_list_entry(self, **params):
        ...
        return _VPCIPv6TranslatorAclListEntryResource(acl_entry_id,self.acl_id, _client=self._client)
...
class _VPCIPv6TranslatorAclListEntryResource(ServiceResource):
    ...
    def modify(self, **params):
        _params = _transfer_params(params)
        self._client.modify_ipv6_translator_acl_list_entry(acl_entry_id=self.acl_entry_id,acl_id=self.acl_id, **_params)

    def remove(self, **params):
        _params = _transfer_params(params)
        self._client.remove_ipv6_translator_acl_list_entry(acl_entry_id=self.acl_entry_id,acl_id=self.acl_id, **_params)
...
class _VPCIPv6TranslatorEntryResource(ServiceResource):
    ...
    def refresh(self):
        result = self._client.describe_ipv6_translator_entries(ipv6_translator_entry_id=self.ipv6_translator_entry_id)
        ...
        if not items:
            raise ClientException(msg=
                                  ...
                                  "Ipv6TranslatorEntryId = {0}".format(self.ipv6_translator_entry_id))
        self._assign_attributes(items[0])
...
class _VPCIpv6GatewayResource(ServiceResource):
    ...
    def allocate_ipv6_internet_bandwidth(self, **params):
        _params = _transfer_params(params)
        self._client.allocate_ipv6_internet_bandwidth(ipv6_gateway_id=self.ipv6_gateway_id, **_params)
