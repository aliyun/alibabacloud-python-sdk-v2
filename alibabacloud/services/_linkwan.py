...
class _LINKWANLabNodeResource(ServiceResource):
    ...
    def apply_roaming_join_permission(self, **params):
        _params = _transfer_params(params)
        return self._client.apply_roaming_join_permission(freq_band_plan_group_id=self.freq_band_plan_group_id, **_params)

    def create_custom_local_join_permission(self, **params):
        _params = _transfer_params(params)
        return self._client.create_custom_local_join_permission(freq_band_plan_group_id=self.freq_band_plan_group_id, **_params)

    def create_gateway(self, **params):
        _params = _transfer_params(params)
        return self._client.create_gateway(freq_band_plan_group_id=self.freq_band_plan_group_id, **_params)

    def create_lab_gateway(self, **params):
        _params = _transfer_params(params)
        return self._client.create_lab_gateway(freq_band_plan_group_id=self.freq_band_plan_group_id, **_params)

    def create_local_join_permission(self, **params):
        _params = _transfer_params(params)
        return self._client.create_local_join_permission(freq_band_plan_group_id=self.freq_band_plan_group_id, **_params)
...
class _LINKWANNotificationResource(ServiceResource):
    ...
    def update_notifications_handle_state(self, **params):
        _params = _transfer_params(params)
        return self._client.update_notifications_handle_state(notification_id=self.notification_id, **_params)
