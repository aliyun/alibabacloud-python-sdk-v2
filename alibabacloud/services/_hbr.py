...
class _HBRBackupSourceGroupResource(ServiceResource):
    ...
    def delete(self, **params):
        _params = _transfer_params(params)
        return self._client.delete_backup_source_group(
            backup_source_group_id=self.backup_source_group_id, **_params)

    def update(self, **params):
        _params = _transfer_params(params)
        return self._client.update_backup_source_group(
            backup_source_group_id=self.backup_source_group_id, **_params)
...
class _HBRContactGroupResource(ServiceResource):
    ...
    def delete(self, **params):
        _params = _transfer_params(params)
        return self._client.delete_contact_group(contact_group_name=self.contact_group_name,
                                                 **_params)

    def update(self, **params):
        _params = _transfer_params(params)
        return self._client.update_contact_group(contact_group_name=self.contact_group_name,
                                                 **_params)
