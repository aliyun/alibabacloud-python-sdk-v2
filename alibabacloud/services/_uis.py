...
class _UISConnectionResource(ServiceResource):
    ...
    def delete(self, **params):
        _params = _transfer_params(params)
        return self._client.delete_uis_connection(uis_connection_id=self.uis_connection_id, **_params)

    def modify_attribute(self, **params):
        _params = _transfer_params(params)
        return self._client.modify_uis_connection_attribute(uis_connection_id=self.uis_connection_id, **_params)
...
class _UISNodeResource(ServiceResource):
    ...
    def __init__(self, uis_node_id, _client=None):
        ...
        self.dnat_entries = _create_sub_resource_without_page_collection(
            ...
            'UisDnatEntries.UisDnatEntry', 'UisDnatId', parent_identifier="UisNodeId",parent_identifier_value=self.uis_node_id
        )
...
class _UISDnatEntryResource(ServiceResource):
    ...
    def delete(self, **params):
        _params = _transfer_params(params)
        return self._client.delete_dnat_entry(uis_dnat_id=self.uis_dnat_id,uis_node_id=self.uis_node_id, **_params)
...
class _UISSubConnectionResource(ServiceResource):
    ...
    def delete(self, **params):
        _params = _transfer_params(params)
        return self._client.delete_sub_connection(uis_sub_connection_id=self.uis_sub_connection_id, **_params)

    def describe(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_sub_connection(uis_sub_connection_id=self.uis_sub_connection_id, **_params)

    def modify(self, **params):
        _params = _transfer_params(params)
        return self._client.modify_sub_connection(uis_sub_connection_id=self.uis_sub_connection_id, **_params)
