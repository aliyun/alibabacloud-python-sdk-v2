...
class _LIVECasterComponentResource(ServiceResource):
    ...
    def delete(self, **params):
        _params = _transfer_params(params)
        return self._client.delete_caster_component(component_id=self.component_id,
                                                    caster_id=self.caster_id, **_params)

    def modify(self, **params):
        _params = _transfer_params(params)
        return self._client.modify_caster_component(component_id=self.component_id,
                                                    caster_id=self.caster_id, **_params)
...
class _LIVECasterEpisodeResource(ServiceResource):
    ...
    def delete(self, **params):
        _params = _transfer_params(params)
        return self._client.delete_caster_episode(episode_id=self.episode_id,
                                                  caster_id=self.caster_id, **_params)

    def modify(self, **params):
        _params = _transfer_params(params)
        return self._client.modify_caster_episode(episode_id=self.episode_id,
                                                  caster_id=self.caster_id, **_params)
...
class _LIVECasterLayoutResource(ServiceResource):
    ...
    def delete(self, **params):
        _params = _transfer_params(params)
        return self._client.delete_caster_layout(layout_id=self.layout_id, caster_id=self.caster_id,
                                                 **_params)

    def modify(self, **params):
        _params = _transfer_params(params)
        return self._client.modify_caster_layout(layout_id=self.layout_id, caster_id=self.caster_id,
                                                 **_params)

    def update_caster_scene_config(self, **params):
        _params = _transfer_params(params)
        return self._client.update_caster_scene_config(layout_id=self.layout_id,
                                                       caster_id=self.caster_id, **_params)
...
class _LIVELiveDomainResource(ServiceResource):
    ...
    def batch_delete_live_domain_configs(self, **params):
        _params = _transfer_params(params)
        return self._client.batch_delete_live_domain_configs(live_domain_name=self.live_domain_name,
                                                             **_params)

    def batch_set_live_domain_configs(self, **params):
        _params = _transfer_params(params)
        return self._client.batch_set_live_domain_configs(live_domain_name=self.live_domain_name,
                                                          **_params)

    def add_live_app_record_config(self, **params):
        _params = _transfer_params(params)
        return self._client.add_live_app_record_config(live_domain_name=self.live_domain_name,
                                                       **_params)

    def add_live_app_snapshot_config(self, **params):
        _params = _transfer_params(params)
        return self._client.add_live_app_snapshot_config(live_domain_name=self.live_domain_name,
                                                         **_params)

    def add_live_detect_notify_config(self, **params):
        _params = _transfer_params(params)
        return self._client.add_live_detect_notify_config(live_domain_name=self.live_domain_name,
                                                          **_params)

    def add_live_pull_stream_info_config(self, **params):
        _params = _transfer_params(params)
        return self._client.add_live_pull_stream_info_config(live_domain_name=self.live_domain_name,
                                                             **_params)

    def add_live_record_notify_config(self, **params):
        _params = _transfer_params(params)
        return self._client.add_live_record_notify_config(live_domain_name=self.live_domain_name,
                                                          **_params)

    def add_live_record_vod_config(self, **params):
        _params = _transfer_params(params)
        return self._client.add_live_record_vod_config(live_domain_name=self.live_domain_name,
                                                       **_params)

    def add_live_snapshot_detect_porn_config(self, **params):
        _params = _transfer_params(params)
        return self._client.add_live_snapshot_detect_porn_config(
            live_domain_name=self.live_domain_name, **_params)
    ...
    def create_live_real_time_log_dery(self, **params):
        _params = _transfer_params(params)
        return self._client.create_live_real_time_log_delivery(
            live_domain_name=self.live_domain_name, **_params)

    def create_live_stream_record_index_files(self, **params):
        _params = _transfer_params(params)
        return self._client.create_live_stream_record_index_files(
            live_domain_name=self.live_domain_name, **_params)
    ...
    def delete_live_app_record_config(self, **params):
        _params = _transfer_params(params)
        return self._client.delete_live_app_record_config(live_domain_name=self.live_domain_name,
                                                          **_params)

    def delete_live_app_snapshot_config(self, **params):
        _params = _transfer_params(params)
        return self._client.delete_live_app_snapshot_config(live_domain_name=self.live_domain_name,
                                                            **_params)

    def delete_live_detect_notify_config(self, **params):
        _params = _transfer_params(params)
        return self._client.delete_live_detect_notify_config(live_domain_name=self.live_domain_name,
                                                             **_params)

    def delete_live_lazy_pull_stream_info_config(self, **params):
        _params = _transfer_params(params)
        return self._client.delete_live_lazy_pull_stream_info_config(
            live_domain_name=self.live_domain_name, **_params)

    def delete_live_pull_stream_info_config(self, **params):
        _params = _transfer_params(params)
        return self._client.delete_live_pull_stream_info_config(
            live_domain_name=self.live_domain_name, **_params)

    def delete_live_realtime_log_dery(self, **params):
        _params = _transfer_params(params)
        return self._client.delete_live_realtime_log_delivery(
            live_domain_name=self.live_domain_name, **_params)

    def delete_live_record_notify_config(self, **params):
        _params = _transfer_params(params)
        return self._client.delete_live_record_notify_config(live_domain_name=self.live_domain_name,
                                                             **_params)

    def delete_live_record_vod_config(self, **params):
        _params = _transfer_params(params)
        return self._client.delete_live_record_vod_config(live_domain_name=self.live_domain_name,
                                                          **_params)

    def delete_live_snapshot_detect_porn_config(self, **params):
        _params = _transfer_params(params)
        return self._client.delete_live_snapshot_detect_porn_config(
            live_domain_name=self.live_domain_name, **_params)

    def delete_live_streams_notify_url_config(self, **params):
        _params = _transfer_params(params)
        return self._client.delete_live_streams_notify_url_config(
            live_domain_name=self.live_domain_name, **_params)

    def describe_live_detect_notify_config(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_live_detect_notify_config(
            live_domain_name=self.live_domain_name, **_params)

    def describe_live_domain_bps_data_by_time_stamp(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_live_domain_bps_data_by_time_stamp(
            live_domain_name=self.live_domain_name, **_params)

    def describe_live_domain_configs(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_live_domain_configs(live_domain_name=self.live_domain_name,
                                                         **_params)

    def describe_live_domain_detail(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_live_domain_detail(live_domain_name=self.live_domain_name,
                                                        **_params)

    def describe_live_domain_frame_rate_and_bit_rate_data(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_live_domain_frame_rate_and_bit_rate_data(
            live_domain_name=self.live_domain_name, **_params)

    def describe_live_domain_mapping(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_live_domain_mapping(live_domain_name=self.live_domain_name,
                                                         **_params)

    def describe_live_domain_online_user_num(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_live_domain_online_user_num(
            live_domain_name=self.live_domain_name, **_params)

    def describe_live_domain_real_time_bps_data(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_live_domain_real_time_bps_data(
            live_domain_name=self.live_domain_name, **_params)

    def describe_live_domain_real_time_http_code_data(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_live_domain_real_time_http_code_data(
            live_domain_name=self.live_domain_name, **_params)

    def describe_live_domain_realtime_log_dery(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_live_domain_realtime_log_delivery(
            live_domain_name=self.live_domain_name, **_params)

    def describe_live_lazy_pull_stream_config(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_live_lazy_pull_stream_config(
            live_domain_name=self.live_domain_name, **_params)

    def describe_live_pull_stream_config(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_live_pull_stream_config(live_domain_name=self.live_domain_name,
                                                             **_params)

    def describe_live_record_config(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_live_record_config(live_domain_name=self.live_domain_name,
                                                        **_params)

    def describe_live_record_notify_config(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_live_record_notify_config(
            live_domain_name=self.live_domain_name, **_params)

    def describe_live_record_vod_configs(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_live_record_vod_configs(live_domain_name=self.live_domain_name,
                                                             **_params)

    def describe_live_snapshot_config(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_live_snapshot_config(live_domain_name=self.live_domain_name,
                                                          **_params)

    def describe_live_snapshot_detect_porn_config(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_live_snapshot_detect_porn_config(
            live_domain_name=self.live_domain_name, **_params)

    def describe_live_stream_bit_rate_data(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_live_stream_bit_rate_data(
            live_domain_name=self.live_domain_name, **_params)

    def describe_live_stream_count(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_live_stream_count(live_domain_name=self.live_domain_name,
                                                       **_params)

    def describe_live_stream_delay_config(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_live_stream_delay_config(
            live_domain_name=self.live_domain_name, **_params)

    def describe_live_stream_history_user_num(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_live_stream_history_user_num(
            live_domain_name=self.live_domain_name, **_params)

    def describe_live_stream_online_user_num(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_live_stream_online_user_num(
            live_domain_name=self.live_domain_name, **_params)

    def describe_live_stream_optimized_feature_config(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_live_stream_optimized_feature_config(
            live_domain_name=self.live_domain_name, **_params)

    def describe_live_stream_record_content(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_live_stream_record_content(
            live_domain_name=self.live_domain_name, **_params)

    def describe_live_stream_record_index_file(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_live_stream_record_index_file(
            live_domain_name=self.live_domain_name, **_params)

    def describe_live_stream_record_index_files(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_live_stream_record_index_files(
            live_domain_name=self.live_domain_name, **_params)

    def describe_live_stream_snapshot_info(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_live_stream_snapshot_info(
            live_domain_name=self.live_domain_name, **_params)

    def describe_live_stream_transcode_stream_num(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_live_stream_transcode_stream_num(
            live_domain_name=self.live_domain_name, **_params)

    def describe_live_streams_block_list(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_live_streams_block_list(live_domain_name=self.live_domain_name,
                                                             **_params)

    def describe_live_streams_control_history(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_live_streams_control_history(
            live_domain_name=self.live_domain_name, **_params)

    def describe_live_streams_frame_rate_and_bit_rate_data(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_live_streams_frame_rate_and_bit_rate_data(
            live_domain_name=self.live_domain_name, **_params)

    def describe_live_streams_notify_url_config(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_live_streams_notify_url_config(
            live_domain_name=self.live_domain_name, **_params)

    def describe_live_streams_online_list(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_live_streams_online_list(
            live_domain_name=self.live_domain_name, **_params)

    def describe_live_streams_publish_list(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_live_streams_publish_list(
            live_domain_name=self.live_domain_name, **_params)

    def disable_live_realtime_log_dery(self, **params):
        _params = _transfer_params(params)
        return self._client.disable_live_realtime_log_delivery(
            live_domain_name=self.live_domain_name, **_params)

    def enable_live_realtime_log_dery(self, **params):
        _params = _transfer_params(params)
        return self._client.enable_live_realtime_log_delivery(
            live_domain_name=self.live_domain_name, **_params)
    ...
    def modify_live_realtime_log_dery(self, **params):
        _params = _transfer_params(params)
        return self._client.modify_live_realtime_log_delivery(
            live_domain_name=self.live_domain_name, **_params)

    def modify_schdm_by_property(self, **params):
        _params = _transfer_params(params)
        return self._client.modify_live_domain_schdm_by_property(
            live_domain_name=self.live_domain_name, **_params)

    def real_time_record_command(self, **params):
        _params = _transfer_params(params)
        return self._client.real_time_record_command(live_domain_name=self.live_domain_name,
                                                     **_params)

    def real_time_snapshot_command(self, **params):
        _params = _transfer_params(params)
        return self._client.real_time_snapshot_command(live_domain_name=self.live_domain_name,
                                                       **_params)
    ...
    def set_live_domain_certificate(self, **params):
        _params = _transfer_params(params)
        return self._client.set_live_domain_certificate(live_domain_name=self.live_domain_name,
                                                        **_params)

    def set_live_lazy_pull_stream_info_config(self, **params):
        _params = _transfer_params(params)
        return self._client.set_live_lazy_pull_stream_info_config(
            live_domain_name=self.live_domain_name, **_params)

    def set_live_stream_delay_config(self, **params):
        _params = _transfer_params(params)
        return self._client.set_live_stream_delay_config(live_domain_name=self.live_domain_name,
                                                         **_params)

    def set_live_stream_optimized_feature_config(self, **params):
        _params = _transfer_params(params)
        return self._client.set_live_stream_optimized_feature_config(
            live_domain_name=self.live_domain_name, **_params)

    def set_live_streams_notify_url_config(self, **params):
        _params = _transfer_params(params)
        return self._client.set_live_streams_notify_url_config(
            live_domain_name=self.live_domain_name, **_params)
    ...
    def update_live_app_snapshot_config(self, **params):
        _params = _transfer_params(params)
        return self._client.update_live_app_snapshot_config(live_domain_name=self.live_domain_name,
                                                            **_params)

    def update_live_detect_notify_config(self, **params):
        _params = _transfer_params(params)
        return self._client.update_live_detect_notify_config(live_domain_name=self.live_domain_name,
                                                             **_params)

    def update_live_record_notify_config(self, **params):
        _params = _transfer_params(params)
        return self._client.update_live_record_notify_config(live_domain_name=self.live_domain_name,
                                                             **_params)

    def update_live_snapshot_detect_porn_config(self, **params):
        _params = _transfer_params(params)
        return self._client.update_live_snapshot_detect_porn_config(
            live_domain_name=self.live_domain_name, **_params)

    def update_live_top_level_domain(self, **params):
        _params = _transfer_params(params)
        return self._client.update_live_top_level_domain(live_domain_name=self.live_domain_name,
                                                         **_params)
