...
class _ADBDBClusterResource(ServiceResource):
    ...
    def allocate_cluster_public_connection(self, **params):
        ...
        return self._client.allocate_cluster_public_connection(db_cluster_id=self.db_cluster_id,
                                                               **_params)
    ...
    def describe_db_cluster_access_white_list(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_db_cluster_access_white_list(db_cluster_id=self.db_cluster_id,
                                                                  **_params)
    ...
    def describe_db_cluster_net_info(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_db_cluster_net_info(db_cluster_id=self.db_cluster_id,
                                                         **_params)

    def describe_db_cluster_performance(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_db_cluster_performance(db_cluster_id=self.db_cluster_id,
                                                            **_params)

    def describe_operator_permission(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_operator_permission(db_cluster_id=self.db_cluster_id,
                                                         **_params)
    ...
    def modify_access_white_list(self, **params):
        _params = _transfer_params(params)
        return self._client.modify_db_cluster_access_white_list(db_cluster_id=self.db_cluster_id,
                                                                **_params)
    ...
    def release_cluster_public_connection(self, **params):
        _params = _transfer_params(params)
        return self._client.release_cluster_public_connection(db_cluster_id=self.db_cluster_id,
                                                              **_params)
