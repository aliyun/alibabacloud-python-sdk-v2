...
class _DCDNDcdnDomainResource(ServiceResource):
    ...
    def batch_delete_dcdn_domain_configs(self, **params):
        _params = _transfer_params(params)
        return self._client.batch_delete_dcdn_domain_configs(dcdn_domain_name=self.dcdn_domain_name,
                                                             **_params)

    def batch_set_dcdn_domain_configs(self, **params):
        _params = _transfer_params(params)
        return self._client.batch_set_dcdn_domain_configs(dcdn_domain_name=self.dcdn_domain_name,
                                                          **_params)

    def batch_set_dcdn_ipa_domain_configs(self, **params):
        _params = _transfer_params(params)
        return self._client.batch_set_dcdn_ipa_domain_configs(
            dcdn_domain_name=self.dcdn_domain_name, **_params)

    def batch_start(self, **params):
        _params = _transfer_params(params)
        return self._client.batch_start_dcdn_domain(dcdn_domain_name=self.dcdn_domain_name,
                                                    **_params)

    def batch_stop(self, **params):
        _params = _transfer_params(params)
        return self._client.batch_stop_dcdn_domain(dcdn_domain_name=self.dcdn_domain_name,
                                                   **_params)
    ...
    def delete_dcdn_ipa_domain(self, **params):
        _params = _transfer_params(params)
        return self._client.delete_dcdn_ipa_domain(dcdn_domain_name=self.dcdn_domain_name,
                                                   **_params)

    def delete_dcdn_specific_config(self, **params):
        _params = _transfer_params(params)
        return self._client.delete_dcdn_specific_config(dcdn_domain_name=self.dcdn_domain_name,
                                                        **_params)

    def describe_dcdn_domain_certificate_info(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_dcdn_domain_certificate_info(
            dcdn_domain_name=self.dcdn_domain_name, **_params)

    def describe_dcdn_domain_cname(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_dcdn_domain_cname(dcdn_domain_name=self.dcdn_domain_name,
                                                       **_params)

    def describe_dcdn_domain_configs(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_dcdn_domain_configs(dcdn_domain_name=self.dcdn_domain_name,
                                                         **_params)

    def describe_dcdn_domain_detail(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_dcdn_domain_detail(dcdn_domain_name=self.dcdn_domain_name,
                                                        **_params)

    def describe_dcdn_domain_http_code_data(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_dcdn_domain_http_code_data(
            dcdn_domain_name=self.dcdn_domain_name, **_params)

    def describe_dcdn_domain_log(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_dcdn_domain_log(dcdn_domain_name=self.dcdn_domain_name,
                                                     **_params)

    def describe_dcdn_domain_pv_data(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_dcdn_domain_pv_data(dcdn_domain_name=self.dcdn_domain_name,
                                                         **_params)

    def describe_dcdn_domain_real_time_bps_data(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_dcdn_domain_real_time_bps_data(
            dcdn_domain_name=self.dcdn_domain_name, **_params)

    def describe_dcdn_domain_real_time_byte_hit_rate_data(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_dcdn_domain_real_time_byte_hit_rate_data(
            dcdn_domain_name=self.dcdn_domain_name, **_params)

    def describe_dcdn_domain_real_time_http_code_data(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_dcdn_domain_real_time_http_code_data(
            dcdn_domain_name=self.dcdn_domain_name, **_params)

    def describe_dcdn_domain_real_time_qps_data(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_dcdn_domain_real_time_qps_data(
            dcdn_domain_name=self.dcdn_domain_name, **_params)

    def describe_dcdn_domain_real_time_req_hit_rate_data(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_dcdn_domain_real_time_req_hit_rate_data(
            dcdn_domain_name=self.dcdn_domain_name, **_params)

    def describe_dcdn_domain_real_time_src_bps_data(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_dcdn_domain_real_time_src_bps_data(
            dcdn_domain_name=self.dcdn_domain_name, **_params)

    def describe_dcdn_domain_real_time_src_traffic_data(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_dcdn_domain_real_time_src_traffic_data(
            dcdn_domain_name=self.dcdn_domain_name, **_params)

    def describe_dcdn_domain_top_refer_visit(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_dcdn_domain_top_refer_visit(
            dcdn_domain_name=self.dcdn_domain_name, **_params)

    def describe_dcdn_domain_top_url_visit(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_dcdn_domain_top_url_visit(
            dcdn_domain_name=self.dcdn_domain_name, **_params)

    def describe_dcdn_domain_uv_data(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_dcdn_domain_uv_data(dcdn_domain_name=self.dcdn_domain_name,
                                                         **_params)

    def describe_dcdn_domain_websocket_http_code_data(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_dcdn_domain_websocket_http_code_data(
            dcdn_domain_name=self.dcdn_domain_name, **_params)

    def describe_dcdn_ipa_domain_configs(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_dcdn_ipa_domain_configs(dcdn_domain_name=self.dcdn_domain_name,
                                                             **_params)

    def describe_dcdn_ipa_domain_detail(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_dcdn_ipa_domain_detail(dcdn_domain_name=self.dcdn_domain_name,
                                                            **_params)

    def modify_dcdn_domain_schdm_by_property(self, **params):
        _params = _transfer_params(params)
        return self._client.modify_dcdn_domain_schdm_by_property(
            dcdn_domain_name=self.dcdn_domain_name, **_params)

    def set_dcdn_domain_certificate(self, **params):
        _params = _transfer_params(params)
        return self._client.set_dcdn_domain_certificate(dcdn_domain_name=self.dcdn_domain_name,
                                                        **_params)
    ...
    def update_dcdn_ipa_domain(self, **params):
        _params = _transfer_params(params)
        return self._client.update_dcdn_ipa_domain(dcdn_domain_name=self.dcdn_domain_name,
                                                   **_params)
