...
class _RDSResource(ServiceResource):
    ...
    def __init__(self, _client=None):
        ...
        self.migrate_tasks = _create_resource_collection(
            ...
            'Items.MigrateTask', 'MigrateTaskId', key_to_total_count="TotalRecordCount",key_to_page_size="PageRecordCount",key_to_page_number="PageNumber"
        )
        ...
        self.slow_logs = _create_resource_collection(
            ...
            'Items.SQLSlowLog', 'SlowLogId', key_to_total_count="TotalRecordCount",key_to_page_size="PageRecordCount",key_to_page_number="PageNumber"
        )
...
class _RDSDBInstanceResource(ServiceResource):
    ...
    def __init__(self, db_instance_id, _client=None):
        ...
        self.accounts = _create_sub_resource_without_page_collection(
            _RDSAccountResource, _client, _client.describe_accounts,
        ...
        self.backups = _create_sub_resource_with_page_collection(
            ...
            'Items.Backup', 'BackupId', parent_identifier="DBInstanceId",parent_identifier_value=self.db_instance_id,key_to_total_count="TotalRecordCount",key_to_page_size="PageRecordCount",key_to_page_number="PageNumber"
        )
        self.dbs = _create_sub_resource_without_page_collection(
            _RDSDBResource, _client, _client.describe_databases,
            'Databases.Database', 'DBName', parent_identifier="DBInstanceId",parent_identifier_value=self.db_instance_id
        )
    ...
    def describe_cross_region_log_backup_files(self, **params):
        _params = _transfer_params(params)
        self._client.describe_cross_region_log_backup_files(db_instance_id=self.db_instance_id, **_params)
    ...
    def describe_db_instance_ip_array_list(self, **params):
        _params = _transfer_params(params)
        self._client.describe_db_instance_ip_array_list(db_instance_id=self.db_instance_id, **_params)
    ...
    def describe_dtc_security_ip_hosts_for_sql_server(self, **params):
        _params = _transfer_params(params)
        self._client.describe_dtc_security_ip_hosts_for_sql_server(db_instance_id=self.db_instance_id, **_params)
    ...
    def describe_instance_vpc_migrate_info(self, **params):
        _params = _transfer_params(params)
        self._client.describe_instance_vpc_migrate_info(db_instance_id=self.db_instance_id, **_params)
    ...
    def describe_migrate_tasks_for_sql_server(self, **params):
        _params = _transfer_params(params)
        self._client.describe_migrate_tasks_for_sql_server(db_instance_id=self.db_instance_id, **_params)
    ...
    def describe_oss_downloads_for_sql_server(self, **params):
        _params = _transfer_params(params)
        self._client.describe_oss_downloads_for_sql_server(db_instance_id=self.db_instance_id, **_params)
    ...
    def describe_security_group_configuration(self, **params):
        _params = _transfer_params(params)
        self._client.describe_security_group_configuration(db_instance_id=self.db_instance_id, **_params)
    ...
    def modify_security_group_configuration(self, **params):
        _params = _transfer_params(params)
        self._client.modify_security_group_configuration(db_instance_id=self.db_instance_id, **_params)
    ...
    def create_temp_db_instance(self, **params):
        _params = _transfer_params(params)
        response = self._client.create_temp_db_instance(db_instance_id=self.db_instance_id,**_params)
        temp_db_instance_id = _new_get_key_in_response(response, 'TempDBInstanceId')
        return _RDSTempDBInstanceResource(temp_db_instance_id,self.db_instance_id, _client=self._client)
...
class _RDSAccountResource(ServiceResource):
    ...
    def check_account_name_available(self, **params):
        _params = _transfer_params(params)
        self._client.check_account_name_available(account_name=self.account_name,db_instance_id=self.db_instance_id, **_params)

    def delete(self, **params):
        _params = _transfer_params(params)
        self._client.delete_account(account_name=self.account_name,db_instance_id=self.db_instance_id, **_params)

    def modify_description(self, **params):
        _params = _transfer_params(params)
        self._client.modify_account_description(account_name=self.account_name,db_instance_id=self.db_instance_id, **_params)

    def reset(self, **params):
        _params = _transfer_params(params)
        self._client.reset_account(account_name=self.account_name,db_instance_id=self.db_instance_id, **_params)

    def reset_account_for_pg(self, **params):
        _params = _transfer_params(params)
        self._client.reset_account_for_pg(account_name=self.account_name,db_instance_id=self.db_instance_id, **_params)

    def reset_account_password(self, **params):
        _params = _transfer_params(params)
        self._client.reset_account_password(account_name=self.account_name,db_instance_id=self.db_instance_id, **_params)

    def grant_account_privilege(self, **params):
        _params = _transfer_params(params)
        self._client.grant_account_privilege(account_name=self.account_name,db_instance_id=self.db_instance_id, **_params)

    def revoke_account_privilege(self, **params):
        _params = _transfer_params(params)
        self._client.revoke_account_privilege(account_name=self.account_name,db_instance_id=self.db_instance_id, **_params)

    def refresh(self):
        result = self._client.describe_accounts(account_name=self.account_name,db_instance_id=self.db_instance_id)
        items = _new_get_key_in_response(result, 'Accounts.DBInstanceAccount')
        if not items:
            raise ClientException(msg=
                                  "Failed to find account data from DescribeAccounts response. "
...
class _RDSBackupResource(ServiceResource):
    ...
    def delete(self, **params):
        _params = _transfer_params(params)
        self._client.delete_backup(backup_id=self.backup_id,db_instance_id=self.db_instance_id, **_params)

    def refresh(self):
        result = self._client.describe_backups(backup_id=self.backup_id,db_instance_id=self.db_instance_id)
...
class _RDSDBResource(ServiceResource):
    ...
    def create_migrate_task(self, **params):
        _params = _transfer_params(params)
        self._client.create_migrate_task(db_name=self.db_name,db_instance_id=self.db_instance_id, **_params)

    def create_migrate_task_for_sql_server(self, **params):
        _params = _transfer_params(params)
        self._client.create_migrate_task_for_sql_server(db_name=self.db_name,db_instance_id=self.db_instance_id, **_params)

    def delete(self, **params):
        _params = _transfer_params(params)
        self._client.delete_database(db_name=self.db_name,db_instance_id=self.db_instance_id, **_params)

    def modify_db_description(self, **params):
        _params = _transfer_params(params)
        self._client.modify_db_description(db_name=self.db_name,db_instance_id=self.db_instance_id, **_params)

    def create_online_database_task(self, **params):
        _params = _transfer_params(params)
        self._client.create_online_database_task(db_name=self.db_name,db_instance_id=self.db_instance_id, **_params)

    def refresh(self):
        result = self._client.describe_databases(db_name=self.db_name,db_instance_id=self.db_instance_id)
        items = _new_get_key_in_response(result, 'Databases.Database')
        if not items:
            raise ClientException(msg=
                                  "Failed to find db data from DescribeDatabases response. "
