...
class _BAASAntChainResource(ServiceResource):
    ...
    def describe_ant_chain_certificate_applications(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_ant_chain_certificate_applications(ant_chain_id=self.ant_chain_id, **_params)

    def describe_ant_chain_download_paths(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_ant_chain_download_paths(ant_chain_id=self.ant_chain_id, **_params)

    def describe_ant_chain_information(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_ant_chain_information(ant_chain_id=self.ant_chain_id, **_params)

    def describe_ant_chain_latest_blocks(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_ant_chain_latest_blocks(ant_chain_id=self.ant_chain_id, **_params)

    def describe_ant_chain_latest_transaction_digests(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_ant_chain_latest_transaction_digests(ant_chain_id=self.ant_chain_id, **_params)

    def describe_ant_chain_transaction(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_ant_chain_transaction(ant_chain_id=self.ant_chain_id, **_params)

    def describe_ant_chain_transaction_statistics(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_ant_chain_transaction_statistics(ant_chain_id=self.ant_chain_id, **_params)
    ...
    def process_cloud_ide_contract_transaction(self, **params):
        _params = _transfer_params(params)
        return self._client.process_cloud_ide_contract_transaction(ant_chain_id=self.ant_chain_id, **_params)
    ...
    def reset_ant_chain_user_certificate(self, **params):
        _params = _transfer_params(params)
        return self._client.reset_ant_chain_user_certificate(ant_chain_id=self.ant_chain_id, **_params)
    ...
    def apply_ant_chain_certificate_with_key_auto_creation(self, **params):
        _params = _transfer_params(params)
        return self._client.apply_ant_chain_certificate_with_key_auto_creation(ant_chain_id=self.ant_chain_id, **_params)

    def apply_ant_chain_with_key_auto_creation(self, **params):
        _params = _transfer_params(params)
        return self._client.apply_ant_chain_with_key_auto_creation(ant_chain_id=self.ant_chain_id, **_params)
...
class _BAASAntChainContractProjectResource(ServiceResource):
    ...
    def describe_ant_chain_contract_project_content_tree(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_ant_chain_contract_project_content_tree(project_id=self.project_id, **_params)
...
class _BAASConsortiumResource(ServiceResource):
    ...
    def describe_ant_chain_contract_projects(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_ant_chain_contract_projects(consortium_id=self.consortium_id, **_params)
    ...
    def describe_consortium_chaincodes(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_consortium_chaincodes(consortium_id=self.consortium_id, **_params)

    def describe_consortium_channels(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_consortium_channels(consortium_id=self.consortium_id, **_params)

    def describe_consortium_deletable(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_consortium_deletable(consortium_id=self.consortium_id, **_params)

    def describe_consortium_member_approval(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_consortium_member_approval(consortium_id=self.consortium_id, **_params)
    ...
    def describe_consortium_orderers(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_consortium_orderers(consortium_id=self.consortium_id, **_params)
...
class _BAASOrganizationResource(ServiceResource):
    ...
    def create_organization_user(self, **params):
        _params = _transfer_params(params)
        return self._client.create_organization_user(organization_id=self.organization_id, **_params)
    ...
    def describe_chaincode_upload_policy(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_chaincode_upload_policy(organization_id=self.organization_id, **_params)
    ...
    def describe_organization_chaincodes(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_organization_chaincodes(organization_id=self.organization_id, **_params)

    def describe_organization_channels(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_organization_channels(organization_id=self.organization_id, **_params)

    def describe_organization_deletable(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_organization_deletable(organization_id=self.organization_id, **_params)

    def describe_organization_members(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_organization_members(organization_id=self.organization_id, **_params)

    def describe_organization_peers(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_organization_peers(organization_id=self.organization_id, **_params)

    def describe_organization_user_certs(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_organization_user_certs(organization_id=self.organization_id, **_params)

    def describe_organization_users(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_organization_users(organization_id=self.organization_id, **_params)

    def describe_orgnaization_chaincodes(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_orgnaization_chaincodes(organization_id=self.organization_id, **_params)
    ...
    def download_organization_sdk(self, **params):
        _params = _transfer_params(params)
        return self._client.download_organization_sdk(organization_id=self.organization_id, **_params)

    def query_organization_deletable(self, **params):
        _params = _transfer_params(params)
        return self._client.query_organization_deletable(organization_id=self.organization_id, **_params)

    def reset_organization_user_password(self, **params):
        _params = _transfer_params(params)
        return self._client.reset_organization_user_password(organization_id=self.organization_id, **_params)
...
class _BAASChaincodeResource(ServiceResource):
    ...
    def describe_chaincode_collection_config(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_chaincode_collection_config(chaincode_id=self.chaincode_id,organization_id=self.organization_id, **_params)

    def install(self, **params):
        _params = _transfer_params(params)
        return self._client.install_chaincode(chaincode_id=self.chaincode_id,organization_id=self.organization_id, **_params)

    def instantiate(self, **params):
        _params = _transfer_params(params)
        return self._client.instantiate_chaincode(chaincode_id=self.chaincode_id,organization_id=self.organization_id, **_params)

    def synchronize(self, **params):
        _params = _transfer_params(params)
        return self._client.synchronize_chaincode(chaincode_id=self.chaincode_id,organization_id=self.organization_id, **_params)

    def upgrade(self, **params):
        _params = _transfer_params(params)
        return self._client.upgrade_chaincode(chaincode_id=self.chaincode_id,organization_id=self.organization_id, **_params)
