...
class _IVISIONPredictTemplateResource(ServiceResource):
    ...
    def modify_attribute(self, **params):
        _params = _transfer_params(params)
        return self._client.modify_predict_template_attribute(template_id=self.template_id,
                                                              **_params)
...
class _IVISIONProjectResource(ServiceResource):
    ...
    def __init__(self, project_id, _client=None):
        ...
        self.iterations = _create_sub_resource_without_page_collection(
            ...
            'Iterations.Iteration', 'IterationId', parent_identifier="ProjectId",
        ...
        self.tags = _create_sub_resource_without_page_collection(
            ...
            'Tags.Tag', 'TagId', parent_identifier="ProjectId",
            parent_identifier_value=self.project_id
        )
    ...
    def modify_train_data_region_tag_attribute(self, **params):
        _params = _transfer_params(params)
        return self._client.modify_train_data_region_tag_attribute(project_id=self.project_id,
                                                                   **_params)
...
class _IVISIONIterationResource(ServiceResource):
    ...
    def create_quick_deploy(self, **params):
        _params = _transfer_params(params)
        return self._client.create_quick_deploy(iteration_id=self.iteration_id,
                                                project_id=self.project_id, **_params)

    def create_train_datas_from_prediction(self, **params):
        _params = _transfer_params(params)
        return self._client.create_train_datas_from_prediction(iteration_id=self.iteration_id,
                                                               project_id=self.project_id,
                                                               **_params)

    def describe_train_result(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_train_result(iteration_id=self.iteration_id,
                                                  project_id=self.project_id, **_params)

    def quick_test(self, **params):
        _params = _transfer_params(params)
        return self._client.quick_test(iteration_id=self.iteration_id, project_id=self.project_id,
                                       **_params)
...
class _IVISIONTagResource(ServiceResource):
    ...
    def create_train_datas(self, **params):
        _params = _transfer_params(params)
        return self._client.create_train_datas_tag(tag_id=self.tag_id, project_id=self.project_id,
                                                   **_params)

    def modify_attribute(self, **params):
        _params = _transfer_params(params)
        return self._client.modify_tag_attribute(tag_id=self.tag_id, project_id=self.project_id,
                                                 **_params)
