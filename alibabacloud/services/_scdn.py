...
class _SCDNScdnDomainResource(ServiceResource):
    ...
    def batch_delete_scdn_domain_configs(self, **params):
        _params = _transfer_params(params)
        return self._client.batch_delete_scdn_domain_configs(scdn_domain_name=self.scdn_domain_name,
                                                             **_params)

    def batch_set_scdn_domain_configs(self, **params):
        _params = _transfer_params(params)
        return self._client.batch_set_scdn_domain_configs(scdn_domain_name=self.scdn_domain_name,
                                                          **_params)

    def batch_update(self, **params):
        _params = _transfer_params(params)
        return self._client.batch_update_scdn_domain(scdn_domain_name=self.scdn_domain_name,
                                                     **_params)
    ...
    def describe_scdn_domain_certificate_info(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_scdn_domain_certificate_info(
            scdn_domain_name=self.scdn_domain_name, **_params)

    def describe_scdn_domain_cname(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_scdn_domain_cname(scdn_domain_name=self.scdn_domain_name,
                                                       **_params)

    def describe_scdn_domain_configs(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_scdn_domain_configs(scdn_domain_name=self.scdn_domain_name,
                                                         **_params)

    def describe_scdn_domain_detail(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_scdn_domain_detail(scdn_domain_name=self.scdn_domain_name,
                                                        **_params)

    def describe_scdn_domain_log(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_scdn_domain_log(scdn_domain_name=self.scdn_domain_name,
                                                     **_params)

    def describe_scdn_domain_pv_data(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_scdn_domain_pv_data(scdn_domain_name=self.scdn_domain_name,
                                                         **_params)

    def describe_scdn_domain_real_time_bps_data(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_scdn_domain_real_time_bps_data(
            scdn_domain_name=self.scdn_domain_name, **_params)

    def describe_scdn_domain_real_time_byte_hit_rate_data(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_scdn_domain_real_time_byte_hit_rate_data(
            scdn_domain_name=self.scdn_domain_name, **_params)

    def describe_scdn_domain_real_time_http_code_data(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_scdn_domain_real_time_http_code_data(
            scdn_domain_name=self.scdn_domain_name, **_params)

    def describe_scdn_domain_real_time_qps_data(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_scdn_domain_real_time_qps_data(
            scdn_domain_name=self.scdn_domain_name, **_params)

    def describe_scdn_domain_real_time_req_hit_rate_data(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_scdn_domain_real_time_req_hit_rate_data(
            scdn_domain_name=self.scdn_domain_name, **_params)

    def describe_scdn_domain_real_time_src_bps_data(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_scdn_domain_real_time_src_bps_data(
            scdn_domain_name=self.scdn_domain_name, **_params)

    def describe_scdn_domain_real_time_src_traffic_data(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_scdn_domain_real_time_src_traffic_data(
            scdn_domain_name=self.scdn_domain_name, **_params)

    def describe_scdn_domain_real_time_traffic_data(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_scdn_domain_real_time_traffic_data(
            scdn_domain_name=self.scdn_domain_name, **_params)

    def describe_scdn_domain_top_refer_visit(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_scdn_domain_top_refer_visit(
            scdn_domain_name=self.scdn_domain_name, **_params)

    def describe_scdn_domain_top_url_visit(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_scdn_domain_top_url_visit(
            scdn_domain_name=self.scdn_domain_name, **_params)

    def describe_scdn_domain_uv_data(self, **params):
        _params = _transfer_params(params)
        return self._client.describe_scdn_domain_uv_data(scdn_domain_name=self.scdn_domain_name,
                                                         **_params)

    def set_domain_server_certificate(self, **params):
        _params = _transfer_params(params)
        return self._client.set_domain_server_certificate(scdn_domain_name=self.scdn_domain_name,
                                                          **_params)

    def set_scdn_domain_certificate(self, **params):
        _params = _transfer_params(params)
        return self._client.set_scdn_domain_certificate(scdn_domain_name=self.scdn_domain_name,
                                                        **_params)
