...
class EdasClient(AlibabaCloudClient):
    ...
    def __init__(self, client_config, credentials_provider=None):
        ...
        self.product_version = '2017-08-01'
    ...
    def install_agent(
        ...
        api_request = APIRequest(
            'InstallAgent', 'POST', 'http', 'ROA', 'query')
    ...
    def query_monitor_info(
        ...
        api_request = APIRequest(
            'QueryMonitorInfo', 'GET', 'http', 'ROA', 'query')
    ...
    def list_ecu_by_region(self, act=None, logical_region_id=None,):
        api_request = APIRequest(
            'ListEcuByRegion', 'GET', 'http', 'ROA', 'query')
    ...
    def insert_cluster(
        ...
        api_request = APIRequest(
            'InsertCluster', 'POST', 'http', 'ROA', 'query')
        api_request.uri_pattern = '/pop/v5/resource/cluster'
        api_request._params = {
    ...
    def authorize_role(self, role_ids=None, target_user_id=None,):
        api_request = APIRequest(
            'AuthorizeRole', 'POST', 'http', 'ROA', 'query')
