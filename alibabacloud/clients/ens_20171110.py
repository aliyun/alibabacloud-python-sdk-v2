...
class EnsClient(AlibabaCloudClient):
    ...
    def modify_image_attribute(self, product=None, image_id=None, image_name=None, version=None):
        ...
        api_request._params = {"product": product, "ImageId": image_id, "ImageName": image_name,
                               "Version": version}
        return self._handle_request(api_request).result
    ...
    def create_instance(self, auto_renew_period=None, period=None, image_id=None, quantity=None,
                        version=None, password=None, system_disk_size=None, auto_renew=None,
                        internet_charge_type=None, ens_region_id=None, instance_type=None,
                        data_disk1_size=None):
        api_request = APIRequest('CreateInstance', 'GET', 'http', 'RPC', 'query')
        api_request._params = {"AutoRenewPeriod": auto_renew_period, "Period": period,
                               "ImageId": image_id, "Quantity": quantity, "Version": version,
                               "Password": password, "SystemDisk.Size": system_disk_size,
                               "AutoRenew": auto_renew, "InternetChargeType": internet_charge_type,
                               "EnsRegionId": ens_region_id, "InstanceType": instance_type,
    ...
    def describe_user_band_width_data(self, period=None, instance_id=None, ens_region_id=None,
                                      end_time=None, start_time=None, version=None):
        api_request = APIRequest('DescribeUserBandWidthData', 'GET', 'http', 'RPC', 'query')
        api_request._params = {"Period": period, "InstanceId": instance_id,
                               "EnsRegionId": ens_region_id, "EndTime": end_time,
                               "StartTime": start_time, "Version": version}
        return self._handle_request(api_request).result
    ...
    def describe_instance_monitor_data(self, period=None, instance_id=None, end_time=None,
                                       start_time=None, version=None):
        api_request = APIRequest('DescribeInstanceMonitorData', 'GET', 'http', 'RPC', 'query')
        api_request._params = {"Period": period, "InstanceId": instance_id, "EndTime": end_time,
                               "StartTime": start_time, "Version": version}
        return self._handle_request(api_request).result

    def describe_instances(self, image_id=None, ens_service_id=None, search_key=None, version=None,
                           page_number=None, order_by_params=None, instance_id=None,
                           instance_name=None, instance_ids=None, ens_region_id=None,
                           page_size=None, ens_region_ids=None, instance_resource_type=None,
                           status=None):
        api_request = APIRequest('DescribeInstances', 'GET', 'http', 'RPC', 'query')
        api_request._params = {"ImageId": image_id, "EnsServiceId": ens_service_id,
                               "SearchKey": search_key, "Version": version,
                               "PageNumber": page_number, "OrderByParams": order_by_params,
                               "InstanceId": instance_id, "InstanceName": instance_name,
                               "InstanceIds": instance_ids, "EnsRegionId": ens_region_id,
                               "PageSize": page_size, "EnsRegionIds": ens_region_ids,
                               "InstanceResourceType": instance_resource_type, "Status": status}
        return self._handle_request(api_request).result

    def describe_images(self, product=None, image_id=None, image_name=None, ens_region_id=None,
                        page_size=None, version=None, page_number=None, status=None):
        api_request = APIRequest('DescribeImages', 'GET', 'http', 'RPC', 'query')
        api_request._params = {"product": product, "ImageId": image_id, "ImageName": image_name,
                               "EnsRegionId": ens_region_id, "PageSize": page_size,
                               "Version": version, "PageNumber": page_number, "Status": status}
        return self._handle_request(api_request).result
    ...
    def modify_instance_attribute(self, password=None, instance_id=None, instance_name=None,
                                  version=None):
        api_request = APIRequest('ModifyInstanceAttribute', 'GET', 'http', 'RPC', 'query')
        api_request._params = {"Password": password, "InstanceId": instance_id,
                               "InstanceName": instance_name, "Version": version}
        return self._handle_request(api_request).result
