...
class RamClient(AlibabaCloudClient):
    ...
    def get_public_key(self, user_public_key_id=None, user_name=None,):
        api_request = APIRequest(
            'GetPublicKey', 'GET', 'https', 'RPC', 'query')
        api_request._params = {
            "UserPublicKeyId": user_public_key_id,
            "UserName": user_name,
        }
    ...
    def change_password(self, old_password=None, new_password=None,):
        api_request = APIRequest(
            'ChangePassword', 'GET', 'https', 'RPC', 'query')
        api_request._params = {
    ...
    def update_role(
        self,
        new_assume_role_policy_document=None,
        role_name=None,
    ):
    ...
    def bind_mfa_device(
        ...
        api_request = APIRequest(
            'BindMFADevice', 'GET', 'https', 'RPC', 'query')
        api_request._params = {
    ...
    def list_policies(self, policy_type=None, marker=None, max_items=None,):
        api_request = APIRequest(
            'ListPolicies', 'GET', 'https', 'RPC', 'query')
        api_request._params = {
            "PolicyType": policy_type,
            "Marker": marker,
            "MaxItems": max_items,
    ...
    def create_policy(
        ...
        api_request = APIRequest(
            'CreatePolicy', 'GET', 'https', 'RPC', 'query')
        api_request._params = {
            "Description": description,
            "PolicyName": policy_name,
            "PolicyDocument": policy_document,
    ...
    def add_user_to_group(self, group_name=None, user_name=None,):
        api_request = APIRequest(
            'AddUserToGroup', 'GET', 'https', 'RPC', 'query')
        api_request._params = {
            "GroupName": group_name,
            "UserName": user_name,
        }
