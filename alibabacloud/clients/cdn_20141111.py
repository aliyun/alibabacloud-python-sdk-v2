...
class CdnClient(AlibabaCloudClient):
    ...
    def describe_l2_vips_by_dynamic_domain(
    ...
    def update_fc_trigger(
        ...
        api_request = APIRequest(
            'UpdateFCTrigger', 'GET', 'http', 'RPC', 'body')
        api_request._params = {
            "Notes": notes,
    ...
    def describe_user_customer_labels(
        self,
        uid=None,
        security_token=None,
        owner_id=None,
    ...
    def set_dynamic_config(
        ...
        api_request = APIRequest(
            'SetDynamicConfig', 'GET', 'http', 'RPC', 'query')
        api_request._params = {
    ...
    def describe_cdn_types(
        ...
        api_request = APIRequest(
            'DescribeCdnTypes', 'GET', 'http', 'RPC', 'query')
        api_request._params = {
            "SecurityToken": security_token,
            "OwnerAccount": owner_account,
            "OwnerId": owner_id,
    ...
    def modify_cdn_domain(
        ...
        api_request = APIRequest(
            'ModifyCdnDomain', 'GET', 'http', 'RPC', 'query')
        api_request._params = {
    ...
    def set_req_auth_config(
        ...
        api_request = APIRequest(
            'SetReqAuthConfig', 'GET', 'http', 'RPC', 'query')
        api_request._params = {
            "Key1": key1,
            "Key2": key2,
    ...
    def set_referer_config(
        ...
        api_request = APIRequest(
            'SetRefererConfig', 'GET', 'http', 'RPC', 'query')
        api_request._params = {
    ...
    def set_range_config(
        ...
        api_request = APIRequest(
            'SetRangeConfig', 'GET', 'http', 'RPC', 'query')
        api_request._params = {
            "SecurityToken": security_token,
            "Enable": enable,
            "DomainName": domain_name,
    ...
    def describe_ip_info(self, security_token=None, ip=None, owner_id=None,):
        api_request = APIRequest(
            'DescribeIpInfo', 'GET', 'http', 'RPC', 'query')
        api_request._params = {
            "SecurityToken": security_token,
            "IP": ip,
            "OwnerId": owner_id,
    ...
    def resume_live_stream(
        ...
        api_request = APIRequest(
            'ResumeLiveStream', 'GET', 'http', 'RPC', 'query')
        api_request._params = {
            "AppName": app_name,
            "SecurityToken": security_token,
    ...
    def forbid_live_stream(
        ...
        api_request = APIRequest(
            'ForbidLiveStream', 'GET', 'http', 'RPC', 'query')
        api_request._params = {
    ...
    def delete_cdn_domain(
        ...
        api_request = APIRequest(
            'DeleteCdnDomain', 'GET', 'http', 'RPC', 'query')
        api_request._params = {
            "ResourceGroupId": resource_group_id,
            "SecurityToken": security_token,
            "DomainName": domain_name,
    ...
    def push_object_cache(
        ...
        api_request = APIRequest(
            'PushObjectCache', 'GET', 'http', 'RPC', 'query')
        api_request._params = {
            "Area": area,
            "SecurityToken": security_token,
    ...
    def open_cdn_service(
        ...
        api_request = APIRequest(
            'OpenCdnService', 'GET', 'http', 'RPC', 'query')
        api_request._params = {
            "SecurityToken": security_token,
    ...
    def modify_cdn_service(
        ...
        api_request = APIRequest(
            'ModifyCdnService', 'GET', 'http', 'RPC', 'query')
        api_request._params = {
            "SecurityToken": security_token,
            "InternetChargeType": internet_charge_type,
            "OwnerId": owner_id,
    ...
    def stop_cdn_domain(
        ...
        api_request = APIRequest(
            'StopCdnDomain', 'GET', 'http', 'RPC', 'query')
        api_request._params = {
            "SecurityToken": security_token,
            "DomainName": domain_name,
            "OwnerId": owner_id,
    ...
    def start_cdn_domain(
        ...
        api_request = APIRequest(
            'StartCdnDomain', 'GET', 'http', 'RPC', 'query')
        api_request._params = {
            "SecurityToken": security_token,
            "DomainName": domain_name,
            "OwnerId": owner_id,
