...
class LinkWANClient(AlibabaCloudClient):
    ...
    def __init__(self, client_config, credentials_provider=None):
        ...
        self.product_version = '2018-12-30'
        self.location_service_code = 'linkwan'
        self.location_endpoint_type = 'openAPI'

    def update_embedded_ns_auto_sync_enabling_state(
            self, instance_id=None, enabled=None,):
    ...
    def submit_external_node_tuples_importing_task(self, node_tuples=None,):
        ...
        repeat_info = {"NodeTuples": ('NodeTuples',
                                      list,
                                      dict,
                                      [('AppSKey',
                                        str,
    ...
    def create_gateway(
        ...
        api_request = APIRequest(
            'CreateGateway', 'GET', 'https', 'RPC', 'body')
        api_request._params = {
            "City": city,
            "Latitude": latitude,
    ...
    def update_gateway(
        ...
        api_request = APIRequest(
            'UpdateGateway', 'GET', 'https', 'RPC', 'body')
        api_request._params = {
            "City": city,
            "Latitude": latitude,
            "Description": description,
    ...
    def count_gateways(
        ...
        api_request = APIRequest(
            'CountGateways', 'GET', 'https', 'RPC', 'body')
        api_request._params = {
            "FuzzyName": fuzzy_name,
            "FuzzyGwEui": fuzzy_gw_eui,
            "FreqBandPlanGroupId": freq_band_plan_group_id,
    ...
    def create_lab_gateway(self, freq_band_plan_group_id=None, name=None,):
        api_request = APIRequest(
            'CreateLabGateway', 'GET', 'https', 'RPC', 'body')
        api_request._params = {
            "FreqBandPlanGroupId": freq_band_plan_group_id,
            "Name": name,
        }
    ...
    def count_lab_gateways(
        ...
        api_request = APIRequest(
            'CountLabGateways', 'GET', 'https', 'RPC', 'body')
        api_request._params = {
            "FuzzyName": fuzzy_name,
            "FuzzyGwEui": fuzzy_gw_eui,
            "FreqBandPlanGroupId": freq_band_plan_group_id,
    ...
    def list_lab_gateways(
        ...
        api_request = APIRequest(
            'ListLabGateways', 'GET', 'https', 'RPC', 'body')
        api_request._params = {
            "FuzzyName": fuzzy_name,
            "Offset": offset,
            "FuzzyGwEui": fuzzy_gw_eui,
    ...
    def create_lab_node(
        ...
        api_request = APIRequest(
            'CreateLabNode', 'GET', 'https', 'RPC', 'body')
        api_request._params = {
            "ClassMode": class_mode,
            "LoraVersion": lora_version,
            "FreqBandPlanGroupId": freq_band_plan_group_id,
    ...
    def count_lab_nodes(
        ...
        api_request = APIRequest(
            'CountLabNodes', 'GET', 'https', 'RPC', 'body')
        api_request._params = {
            "FuzzyName": fuzzy_name,
    ...
    def list_lab_node_logs(
        ...
        api_request = APIRequest(
            'ListLabNodeLogs', 'GET', 'https', 'RPC', 'body')
        api_request._params = {
            "EndMillis": end_millis,
            "PageNumber": page_number,
            "DevEui": dev_eui,
    ...
    def update_lab_node(
        ...
        api_request = APIRequest(
            'UpdateLabNode', 'GET', 'https', 'RPC', 'body')
        api_request._params = {
            "ClassMode": class_mode,
            "DevEui": dev_eui,
            "LoraVersion": lora_version,
    ...
    def create_node_group(
        ...
        api_request = APIRequest(
            'CreateNodeGroup', 'GET', 'http', 'RPC', 'body')
        api_request._params = {
    ...
    def update_node_group(self, node_group_name=None, node_group_id=None,):
        api_request = APIRequest(
            'UpdateNodeGroup', 'GET', 'https', 'RPC', 'body')
        api_request._params = {
            "NodeGroupName": node_group_name,
            "NodeGroupId": node_group_id,
        }
    ...
    def list_node_groups(
        ...
        api_request = APIRequest(
            'ListNodeGroups', 'GET', 'https', 'RPC', 'body')
        api_request._params = {
            "FuzzyName": fuzzy_name,
            "Offset": offset,
            "FuzzyJoinEui": fuzzy_join_eui,
    ...
    def count_node_groups(
        ...
        api_request = APIRequest(
            'CountNodeGroups', 'GET', 'https', 'RPC', 'body')
        api_request._params = {
            "FuzzyName": fuzzy_name,
            "FuzzyJoinEui": fuzzy_join_eui,
            "FuzzyDevEui": fuzzy_dev_eui,
    ...
    def add_node_to_group(
        ...
        api_request = APIRequest(
            'AddNodeToGroup', 'GET', 'https', 'RPC', 'body')
        api_request._params = {
            "DevEui": dev_eui,
            "PinCode": pin_code,
            "NodeGroupId": node_group_id,
