...
class EciClient(AlibabaCloudClient):
    ...
    def __init__(self, client_config, credentials_provider=None):
        ...
        self.product_version = '2018-08-08'
    ...
    def update_container_group(
        ...
        repeat_info = {"Container": ('Container',
                                     list,
                                     dict,
                                     [('Name',
                                       str,
                       ...
                       "DnsConfig.NameServer": ('DnsConfig.NameServer',
                                                list,
                                                str,
                                                None),
                       "DnsConfig.Option": ('DnsConfig.Option',
                                            list,
                                            dict,
                                            [('Name',
                                              str,
                       ...
                       "DnsConfig.Search": ('DnsConfig.Search',
                                            list,
                                            str,
                                            None),
                       "Volume": ('Volume',
    ...
    def create_container_group(
        ...
        repeat_info = {"Container": ('Container',
                       ...
                       "DnsConfig.NameServer": ('DnsConfig.NameServer',
                                                ...
                                                str,
                                                None),
                       "SecurityContext.Sysctl": ('SecurityContext.Sysctl',
                                                  list,
                                                  dict,
                                                  [('Name',
                                                    str,
