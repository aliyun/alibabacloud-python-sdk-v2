    ...
    def update_container_group(
        ...
        repeat_info = {"Container": ('Container', 'list', 'dict', [('Name', 'str', None, None),
                ...
                ('Port', 'str', None, None),
                                                      ...
                                                      ],), ('ReadinessProbe.TcpSocket.Port', 'str',
                                                            None, None),
                       ...
                       "InitContainer": (
                       'InitContainer', 'list', 'dict', [('Name', 'str', None, None),
                                                         ('Image', 'str', None, None),
                                                         ('Cpu', 'str', None, None),
                                                         ('Memory', 'str', None, None),
                                                         ('WorkingDir', 'str', None, None),
                                                         ...
                                                         'SecurityContext.ReadOnlyRootFilesystem',
                                                         'str', None, None),
                                                         ('SecurityContext.RunAsUser', 'str', None,
                                                          None),
                                                         ('SecurityContext.Capability.Add', 'list',
                                                          'str', None),
                                                         ('Gpu', 'str', None, None),
                                                         ]),
                       "ImageRegistryCredential": (
                       'ImageRegistryCredential', 'list', 'dict', [('Server', 'str', None, None),
                       ...
                       "DnsConfig.Option": (
                       'DnsConfig.Option', 'list', 'dict', [('Name', 'str', None, None),
                                                            ('Value', 'str', None, None),
                                                            ]),
                       ...
                       "Volume": ('Volume', 'list', 'dict', [('Name', 'str', None, None),
                                                             ...
                                                             'EmptyDirVolume.Medium', 'str', None,
                                                             None),
                                                             ]),
                       }
        ...
        repeat_info = {"Container": ('Container', 'list', 'dict', [('Image', 'str', None, None),
                       ...
                       "Volume": ('Volume', 'list', 'dict', [('Name', 'str', None, None),
                                                             ...
                                                             ('EmptyDirVolume.Medium', 'str', None,
                                                              None),
                                                             (
                                                             'ConfigFileVolume.DefaultModel', 'str',
                                                             None, None),
                                                             ]),
                       "InitContainer": (
                       'InitContainer', 'list', 'dict', [('Name', 'str', None, None),
                       ...
                       'SecurityContext.Sysctl', 'list', 'dict', [('Name', 'str', None, None),
                                                                  ('Value', 'str', None, None),
                                                                  ]),
                       "DnsConfig.Option": (
                       'DnsConfig.Option', 'list', 'dict', [('Name', 'str', None, None),
