...
class AlibabaClientTest(TestCase):
    ...
    def test_ecs_client(self):
        client = alibabacloud.client(service_name='Ecs', api_version='2014-05-26',
    ...
    def test_not_support_client(self):
        try:
            client = alibabacloud.client(service_name='Ems', api_version='2014-05-26',
                                         access_key_id=self.access_key_id,
                                         access_key_secret=self.access_key_secret,
                                         region_id=self.region_id)
            assert False
    ...
    def test_not_support_version(self):
        try:
            client = alibabacloud.client(service_name='ECS', api_version='2015-05-26',
                                         access_key_id=self.access_key_id,
                                         access_key_secret=self.access_key_secret,
                                         region_id=self.region_id)
            assert False
